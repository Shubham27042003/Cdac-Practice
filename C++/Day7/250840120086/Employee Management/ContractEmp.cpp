...
ContractEmp::ContractEmp(int empno, const char* ename, const char* dept, const char* desg, int hrs, double charges)
...
void ContractEmp::setHrs(int hrs) {
    this->hrs = hrs;
}
