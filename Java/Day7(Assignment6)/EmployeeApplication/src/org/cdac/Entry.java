		...
		do {
			...
			case 1: {
				...
				do {
					...
					if (addChoice >= 1 && addChoice < 4) {
						employeesList.adddata(addEmployees(addChoice));
						count++;
					}
			...
			case 6: {
				...
				do {
					...
					case 2:
					{
						System.out.println(employeesList.getNext());
					}
					break;
					case 3:
					{
						System.out.println(employeesList.getPrevious());
					}
					break;
					case 4:
					{
